...
###
console   = Console()
logging.basicConfig(level="ERROR", format="%(message)s", datefmt="[%X]", handlers=[RichHandler(console=console, rich_tracebacks=True)])
...
if __name__ == "__main__":
    ...
    #Create Agents
    agents_df['crewAIAgent'] = agents_df.apply(lambda row: create_agents_from_df(row, models_df=models_df, tools_df=tools_df), axis=1)
